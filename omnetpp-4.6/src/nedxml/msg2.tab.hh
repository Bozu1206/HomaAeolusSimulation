...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    EXTENDS = 267,                 /* EXTENDS  */
    FIELDS = 268,                  /* FIELDS  */
    PROPERTIES = 269,              /* PROPERTIES  */
    ABSTRACT = 270,                /* ABSTRACT  */
    READONLY = 271,                /* READONLY  */
    NAME = 272,                    /* NAME  */
    PROPNAME = 273,                /* PROPNAME  */
    DOUBLECOLON = 274,             /* DOUBLECOLON  */
    INTCONSTANT = 275,             /* INTCONSTANT  */
    REALCONSTANT = 276,            /* REALCONSTANT  */
    STRINGCONSTANT = 277,          /* STRINGCONSTANT  */
    CHARCONSTANT = 278,            /* CHARCONSTANT  */
    TRUE_ = 279,                   /* TRUE_  */
    FALSE_ = 280,                  /* FALSE_  */
    BOOLTYPE = 281,                /* BOOLTYPE  */
    CHARTYPE = 282,                /* CHARTYPE  */
    SHORTTYPE = 283,               /* SHORTTYPE  */
    INTTYPE = 284,                 /* INTTYPE  */
    LONGTYPE = 285,                /* LONGTYPE  */
    DOUBLETYPE = 286,              /* DOUBLETYPE  */
    UNSIGNED_ = 287,               /* UNSIGNED_  */
